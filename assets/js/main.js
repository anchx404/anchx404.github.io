...
let mixerPortfolio = mixitup('.study__container', {
    selectors: {
        target: '.study__card'
    },
    animation: {
...
// link active project
const linkProject = document.querySelectorAll('.study__item')

function activeProject() {
    linkProject.forEach(l => l.classList.remove('active-note'))
...
function scrollFunction() {
  if (document.body.scrollTop > 200 || document.documentElement.scrollTop > 300) {
    ...
    document.getElementById("topbanner").style.top = "-500px";
  }
}
